...
test('should add photos', () => {
   ...
   expect(reducer(previousState, loadPhotos(photos))).toEqual({
      ...
      albums: { 
         ...
         2: {albumId: 1, id: 2, title: 'reprehenderit est deserunt velit ipsam', url: 'https://via.placeholder.com/600/771796', thumbnailUrl: 'https://via.placeholder.com/150/771796'}
      }
   })
})